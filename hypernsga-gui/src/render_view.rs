...
use super::{render_graph, render_cppn, Transformation, ViewMode};
use std::cmp::Ordering;


pub fn render_view(view_mode: ViewMode, parents: &RankedPopulation<G, Fitness>, best_individual_i: usize,
